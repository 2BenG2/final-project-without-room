...
public final class FragmentMainBinding implements ViewBinding {
  ...
  private FragmentMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout infoPage, @NonNull TextView message) {
  ...
  public static FragmentMainBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      ConstraintLayout infoPage = (ConstraintLayout) rootView;
      ...
      return new FragmentMainBinding((ConstraintLayout) rootView, infoPage, message);
    }
