...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnSignOut,
      @NonNull ConstraintLayout container, @NonNull Guideline guideline14,
      @NonNull Guideline guideline2, @NonNull BottomNavigationView navView,
      @NonNull TextView tvUserDetails) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, btnSignOut, container,
          guideline14, guideline2, navView, tvUserDetails);
    }
